...
class ResNet_fixedImgSize(nn.Module):
    def __init__(self):
        ...
        self.res_layers = nn.Sequential(ResBlock(3, 64),
                                        ResBlock(64, 64),
                                        ResBlock(64, 64),
                                        ResBlock(64, 64),
                                        )
...
def Conv2D_BN_ReLU(ch_in, ch_out, kernel = 3, padding = 1, stride = 1):
...
class ResBlock(nn.Module):
    ...
    def __init__(self, ch_in, ch_out):
        ...
        self.block1 = Conv2D_BN_ReLU(ch_in, ch_out, kernel=3, padding=1)
        self.block2 = Conv2D_BN_ReLU(ch_out, ch_out, kernel=3, padding=1)
...
class UNet_V3(nn.Module):
    ...
    def __init__(self, n_class, freeze=False):
        ...
        self.ResNet_Input_to_Output = ResNet_fixedImgSize()  # 3 to 64
